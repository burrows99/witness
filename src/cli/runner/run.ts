...
import { DapSession, type InstalledProbe } from '../../probe-dap/index.js'
import { ApiDriver, assertionKinds, newTraceId } from '../../driver-api/index.js'
import { ArtifactStore, createRecorders, slideDocument, type Slide, type TerminalSource } from '../../recorders/index.js'
...
async function loadDrivers(
  ...
  const web = await import('../../driver-web/index.js').catch(() => null)
...
async function evaluateAssertions(
  ...
  if (web) {
    const { uiText } = await import('../../driver-web/index.js')
