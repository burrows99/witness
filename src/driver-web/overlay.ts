/// <reference lib="dom" />
// Scoped to this file rather than the whole compilation: everything else here
// is Node-only, and a codebase where any module can reach for `document` loses
// the property that the gate runs headless.
