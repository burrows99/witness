import { readString, type AssertionKind, type AssertionResult, type StoryView } from '../core/index.js'
...
function readPath(root: unknown, path: string): { value: unknown; missing: boolean } {
